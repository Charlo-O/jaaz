...
# 安装全局base64过滤器
from utils.base64_filter import install_global_base64_filter
...
<<<<<<< Updated upstream
from routers import config_router, image_router, video_router, multimodal_router, root_router, workspace, canvas, ssl_test, chat_router, settings, tool_confirmation
=======
from routers import (
    config_router,
    image_router,
